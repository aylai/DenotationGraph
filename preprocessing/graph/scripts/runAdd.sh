...
./makeOutputNP.pl ../tmp/$1 ../../corpora/$1/graph ../../corpora/$2/graph
./propogateImage.pl ../../corpora/$1/graph/np-tree.txt ../../corpora/$1/graph/np-cap.map
./makeOutputVP.pl ../../corpora/$1/$1 ../tmp/$1 ../../corpora/$1/graph ../../corpora/$2/graph
./propogateImage.pl ../../corpora/$1/graph/vp-tree.txt ../../corpora/$1/graph/vp-cap.map
./makeOutput.pl ../tmp/$1 ../../corpora/$1/graph ../../corpora/$2/graph
